...
*/
    ...
    private fun sendHelp(stack: CommandSourceStack, page: Int) {
        val commands = listOf(
            ...
            "  <gold>/banip <player> (time) <reason> [--force] ",
            "  <gold>/banip ip <ip> (time) <reason> [--force] ",
            "         <gray>- <white>Bans a player's IP, optionally ignoring bypass.",
            "  <gold>/unban <player> <gray>- <white>Unbans a player.",
            "  <gold>/unban ip <ip> <gray>- <white>Unbans an IP.",
