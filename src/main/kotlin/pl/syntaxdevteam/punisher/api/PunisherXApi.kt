...
interface PunisherXApi {
    ...
    /**
     * Retrieves all active punishments, optionally filtered by type.
     *
     ...
     */
    fun getActivePunishments(type: String? = null): CompletableFuture<List<PunishmentData>>

    /**
     * Retrieves the punishment history, optionally filtered by type.
     *
     * @param type The type of punishment to filter by (optional).
     * @return A CompletableFuture containing a list of PunishmentData records from the history.
     */
    fun getPunishmentHistory(type: String? = null): CompletableFuture<List<PunishmentData>>

    /**
     * Retrieves the count of active punishments for a given player and type.
     *
     * @param uuid The UUID of the player.
     * @param type The type of punishment.
     * @return A CompletableFuture containing the count of active punishments.
     */
    fun getActivePunishmentsCount(uuid: String, type: String): CompletableFuture<Int>
}